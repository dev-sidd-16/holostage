...
void VulkanExampleBase::stopRenderLoop() {
	rendering = false;
}
...
void VulkanExampleBase::initVulkan()
{
	...
	VkResult res = vulkanDevice->createLogicalDevice(enabledFeatures, enabledExtensions, true, VK_QUEUE_GRAPHICS_BIT);
	if (res != VK_SUCCESS) {
