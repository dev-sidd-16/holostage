...
import com.meteor_studio.holostage.R;
...
public class ImageTargets extends NativeActivity {
    ...
    private static final String NATIVE_LIB_SAMPLE = "vulkanPipelines";

    public static final String LICENCE_KEY = "";
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                Vuforia.setInitParameters(ImageTargets.this, mVuforiaFlags, LICENCE_KEY);
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Don't let native code take the surface of the whole window
        getWindow().takeSurface(null);
        // Don't let the native code take the input events
...
//            .add(Texture.loadTextureFromApk("Buildings.jpeg", getAssets()));
    ...
    private void initView(){
        ...
        ViewGroup.LayoutParams lp = new ViewGroup.LayoutParams(match, match);
        addContentView(surfaceView, lp);
    }
